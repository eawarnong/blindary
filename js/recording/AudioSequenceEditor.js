function AudioLayerSequenceEditor(elementContext)
{
    ...
    this.canvasWidth = elementContext.parentNode.parentNode.clientWidth - 2;
    ...
    this.createEditor = function createEditor()
    {
        ...
        this.canvasReference.style['border'] = '1px solid #F7BE1E';
    ...
    this.addEventlistener = function addEventListener()
    {
        ...
        this.canvasReference.onmousemove = function(e)
        {
            ...
            this.eventHost.mouseX = e.clientX - (rect.left).toFixed(0);
            this.eventHost.mouseY = e.clientY - (rect.top).toFixed(0);
